#include "optimal_cost_partitioning_heuristic_old.h"
...
OptimalCostPartitioningHeuristicOld::OptimalCostPartitioningHeuristicOld(
    ...
    if (num_operators != static_cast<int>(TaskProxy(*tasks::g_root_task).get_operators().size())) {
        ABORT("OptimalCostPartitioningHeuristicOld doesn't work for task "
...
void OptimalCostPartitioningHeuristicOld::release_memory() {
...
int OptimalCostPartitioningHeuristicOld::compute_heuristic(const GlobalState &global_state) {
...
void OptimalCostPartitioningHeuristicOld::generateLP() {
...
void OptimalCostPartitioningHeuristicOld::introduce_abstraction_variables(
...
void OptimalCostPartitioningHeuristicOld::add_abstraction_constraints(
...
static Heuristic *_parse(OptionParser &parser) {
    ...
    return new OptimalCostPartitioningHeuristicOld(opts);
}

static Plugin<Heuristic> _plugin("optimal_cost_partitioning_old", _parse);
}
