#ifndef COST_SATURATION_OPTIMAL_COST_PARTITIONING_HEURISTIC_OLD_H
#define COST_SATURATION_OPTIMAL_COST_PARTITIONING_HEURISTIC_OLD_H
...
class OptimalCostPartitioningHeuristicOld : public Heuristic {
    class MatrixEntry {
public:
        int row;
        int col;
...
public:
    explicit OptimalCostPartitioningHeuristicOld(const options::Options &opts);
    virtual ~OptimalCostPartitioningHeuristicOld() override;
};
}
