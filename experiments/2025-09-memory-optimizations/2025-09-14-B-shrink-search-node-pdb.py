...
CONFIGS = [
    ("scorpion", ["--search", f"astar(scp_online([projections(sys_scp(max_time={MAX_TIME_OUTER}, max_time_per_restart={MAX_TIME_INNER}))], saturator=perimstar, max_time=1000, interval=10K, orders=greedy_orders()), pruning=limited_pruning(pruning=atom_centric_stubborn_sets(), min_required_pruning_ratio=0.2))"]),
]
BUILD_OPTIONS = []
DRIVER_OPTIONS = [
    "--preprocess",
