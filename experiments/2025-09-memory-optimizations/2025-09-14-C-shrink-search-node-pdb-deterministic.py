...
CONFIGS = [
    ("scorpion", ["--search", f"astar(scp([projections(systematic(2))], saturator=perimstar, max_orders=1, orders=greedy_orders()), pruning=limited_pruning(pruning=atom_centric_stubborn_sets(), min_required_pruning_ratio=0.2))"]),
]
BUILD_OPTIONS = []
DRIVER_OPTIONS = [
    "--preprocess",
