...
BENCHMARKS_DIR = Path(os.environ["DOWNWARD_BENCHMARKS"]) / ".." / "unsolvable-benchmarks"
SCP_LOGIN = "nsc"
REMOTE_REPOS_DIR = "/proj/dfsplan/users/x_jense/"
SUITE = ["bottleneck-uns16:p01.pddl"]
REVISION_CACHE = (
...
if project.REMOTE:
    ...
    SUITE = [
        ...
        "bottleneck-uns16",
        "cavediving-uns16",
        "chessboard-pebbling-uns16",
        "diagnosis-uns16",
        "document-transfer-uns16",
        "over-nomystery-uns16",
        "over-rovers-uns16",
        "over-tpp-uns16",
        "pegsol-row5-uns16",
        "pegsol-uns16",
...
filters = [project.check_initial_h_value, filter.check_costs, project.check_search_started, project.add_evaluations_per_time]
