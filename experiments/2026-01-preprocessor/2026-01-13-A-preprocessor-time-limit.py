...
CONFIGS = [
    ("blind", ["--preprocess-options", "--h2-time-limit", "30", "--search-options", "--search", "astar(blind(), bound=0)"]),
]
BUILD_OPTIONS = []
DRIVER_OPTIONS = [
    "--preprocess",
...
REV_NICKS = [
    ("e31f5189", "coarse-grained-checks"),
    ("5deb146a", "fine-grained-checks"),
]
ATTRIBUTES = [
    "error",
    "run_dir",
    ...
    "preprocessor_*",
    Attribute("preprocessor_time", function=max),
    Attribute("preprocessor_mutex_computation_time", function=max),
]
