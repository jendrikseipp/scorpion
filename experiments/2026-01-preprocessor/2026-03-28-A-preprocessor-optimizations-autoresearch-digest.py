...
REV_NICKS = [
    ("7d742a2d", "01-base"),
    ("a33825d3", "40-add-preprocessor-speed-tests"),
    ("c90803c1", "41-word-bitsets-and-byte-arrays"),
    ("8ad2eb91", "42-no-endl-sas-write"),
    ("3cbc1023", "43-no-endl-unreachable"),
    ("3be26363", "44-byte-apply-caches"),
    ("016397d6", "45-reuse-candidate-slots"),
]
ATTRIBUTES = [
    "error",
    "run_dir",
...
project.add_scatter_plot_reports(exp, [
        ("01-base-blind", "40-add-preprocessor-speed-tests-blind"),
        ("40-add-preprocessor-speed-tests-blind", "41-word-bitsets-and-byte-arrays-blind"),
        ("41-word-bitsets-and-byte-arrays-blind", "42-no-endl-sas-write-blind"),
        ("42-no-endl-sas-write-blind", "43-no-endl-unreachable-blind"),
        ("43-no-endl-unreachable-blind", "44-byte-apply-caches-blind"),
        ("44-byte-apply-caches-blind", "45-reuse-candidate-slots-blind"),
    ], ["preprocessor_time"])
