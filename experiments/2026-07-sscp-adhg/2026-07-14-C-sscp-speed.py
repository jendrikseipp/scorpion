...
"""
Confirmation run for runs 58-60 of the autoresearch loop (two-level diff
masks, memo-probe-first partitioning, frontier-search components; psr47
DAG generation -27%, guard suite -13%).

Single revision on all optimal STRIPS benchmarks with the same limits as
2026-07-13-A and 2026-07-14-B, so coverage is directly comparable.
"""
