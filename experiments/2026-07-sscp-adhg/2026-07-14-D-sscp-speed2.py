...
"""
Confirmation run for runs 62-63 of the autoresearch loop (word-mask
negative/exhausted tracking and mask-only infinite-cost simulation;
probe construction time 0.937 -> 0.609, guard suite 0.45 -> 0.40).
