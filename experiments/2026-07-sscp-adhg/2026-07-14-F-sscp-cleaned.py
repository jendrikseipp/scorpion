...
"""
Confirmation run for the consolidation audit (runs 67-68): removed the
dead connected-components library and the redundant pre-partition memo
probe. Verifies coverage and initial h are unchanged vs 09-final.
