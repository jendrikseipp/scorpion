...
CONFIGS = [
    ("bjolp-scp", ["--evaluator", "lmc=lmcount(lm_merged([lm_rhw(),lm_hm(m=1)]), admissible=true, cost_partitioning=suboptimal, greedy=True, reuse_costs=True, scoring_function=max_heuristic_per_stolen_costs)", "--search", "astar(lmc,lazy_evaluator=lmc)"]),
]
BUILD_OPTIONS = []
DRIVER_OPTIONS = [
    "--validate",
...
REVS = [
    ("f34bf6881", "01-remove-flag"),
    ("a7280ef1f", "02-use-phmap-for-util-hash"),
    ("c6e7e2285", "03-use-phmap-for-lm-achievers"),
    ("98ab2b5cb", "04-no-copy-achievers"),
]
ATTRIBUTES = [
    "error",
    "run_dir",
