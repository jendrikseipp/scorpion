...
scp = ["-DCMAKE_BUILD_TYPE=Release", "-DDISABLE_PLUGINS_BY_DEFAULT=YES", "-DPLUGIN_COST_SATURATION_ENABLED=YES", "-DPLUGIN_PLUGIN_ASTAR_ENABLED=YES"]
scpdebug = ["-DCMAKE_BUILD_TYPE=Debug", "-DDISABLE_PLUGINS_BY_DEFAULT=YES", "-DPLUGIN_COST_SATURATION_ENABLED=YES", "-DPLUGIN_PLUGIN_ASTAR_ENABLED=YES"]
